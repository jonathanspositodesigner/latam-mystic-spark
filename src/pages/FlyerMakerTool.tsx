...
const FlyerMakerTool: React.FC = () => {
  ...
  const handleReset = () => {
    ...
    setMotionJobId(null);
    setMotionAudioFile(null);
    setMotionResolution('480p');
    setOutputImage(null);
    setJobId(null);
    ...
    <AppLayout>
      <div className="h-full flex flex-col p-4 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1">
          ...
          <div className="lg:col-span-8 bg-card border border-border rounded-2xl p-5 overflow-y-auto flex items-center justify-center">
            {flyerScreen === 'choose' ? (
              <div className="text-center space-y-2">
                <h1 className="text-3xl font-bold text-white">Flyer Maker</h1>
                <p className="text-muted-foreground">Crea artes profesionales para tus eventos en segundos</p>
